...
insert into cidade (id, nome, estado_id) values (1, 'Uberlândia', 13);
insert into cidade (id, nome, estado_id) values (2, 'Belo Horizonte', 13);
insert into cidade (id, nome, estado_id) values (3, 'São Paulo', 25);
insert into cidade (id, nome, estado_id) values (4, 'Campinas', 25);
insert into cidade (id, nome, estado_id) values (5, 'Fortaleza', 6);

insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, endereco_complemento) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, utc_timestamp, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro', '');
