...
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Algas do Mar', 0.25, 1);
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Gaucho de Ubatuba', 0.27, 2);
